# Celeschain Testnet Automations Bot

### Description
Celeschain Testnet Automations Bot is an automated Python script designed to interact with various Celeschain Testnet platforms and streamline routine activities. It helps users perform multiple tasks efficiently, including daily check-ins, claiming faucet tokens, swapping tokens on supported dApps, adding liquidity, sending tokens, completing missions, and managing referrals automatically.

This bot is built to simplify participation in the Celeschain Testnet ecosystem by reducing manual work and enabling consistent interaction with available features and tasks.
...
1. Clone this repository:
   ```bash
   git clone https://github.com/genoshide/celeschain-testnet-bot.git
   cd celeschain-testnet-bot
   ```
